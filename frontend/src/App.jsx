          ...
          <div className="fixed inset-0 z-[250] bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-white rounded-[32px] shadow-2xl max-w-2xl w-full p-10 max-h-[80vh] overflow-y-auto relative animate-in fade-in zoom-in duration-300">
              ...
              <div className="space-y-4 text-xs text-slate-600 leading-relaxed font-semibold uppercase text-left">
                <p>Настоящая Политика определяет порядок обработки и защиты персональных данных пользователей Системы «AI Sentinel».</p>
                <h4 className="font-black text-slate-800 text-[10px] tracking-wider mt-4">1. Какие данные мы обрабатываем</h4>
                <p>Мы собираем только минимально необходимый набор данных для авторизации: адрес электронной почты (email), хэшированный пароль и тексты загружаемых научных работ.</p>
                <h4 className="font-black text-slate-800 text-[10px] tracking-wider mt-4">2. Цели обработки</h4>
                <p>Данные обрабатываются исключительно в целях предоставления доступа к личному кабинету, сохранения истории проверок, формирования отчетов нормоконтроля и верификации оригинальности научных трудов.</p>
                <h4 className="font-black text-slate-800 text-[10px] tracking-wider mt-4">3. Безопасность и третьи лица</h4>
                <p>Мы гарантируем конфиденциальность. Ваши данные и тексты работ не передаются третьим лицам. Для детекции ИИ-генерации тексты передаются по защищенному шифрованному каналу API.</p>
              </div>
              <button 
                type="button"
                  ...
                  <table className="w-full text-left border-collapse table-fixed">
                    <thead>
                      <tr className="bg-slate-50/50 border-b border-slate-100">
                        ...
                        <th className="p-8 text-[10px] font-black uppercase tracking-[2px] text-slate-400 w-[150px] text-right">Точность</th>
